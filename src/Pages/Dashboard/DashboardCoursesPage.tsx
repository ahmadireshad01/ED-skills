        ...
        <div className="flex bg-[#fafaf5] h-screen overflow-hidden">
            ...
            <div className="px-[9%] lg:pt-11 pt-[90px] lg:ml-[25px] xl:ml-0 w-full overflow-y-auto overflow-x-hidden scrollbar-hide">
                ...
                <div className={`relative flex flex-col w-full ${layout === 'list' ? 'items-start' : 'items-center'}`}>
                    <div className={`w-full grid items-center ml-[14%] md:ml-0  ${layout === "list" ? "grid-cols-1" : "grid-cols-1  sm:grid-cols-2 md:grid-cols-2 [@media_(min-width:1520px)_and_(max-width:1730px)]:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 [@media_(min-width:1270px)_and_(max-width:1370px)]:grid-cols-3 2xl:grid-cols-5 3xl:grid-cols-6"}   xl:gap-x-8 gap-x-8 lg:gap-x-21 gap-y-6`}>
                        {
