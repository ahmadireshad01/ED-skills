        ...
        <div className="flex bg-[#fafaf5]">
            ...
            <div className="flex flex-col m-[30px] w-full ">
                <div className="flex items-center justify-between ">
                    ...
                    <button className="flex items-center justify-center gap-1 shadow-[0px_5.33px_0px_0px_#FF3400] w-[147px] h-[58px] rounded-[29px] border border-orange-500 font-[roboto] font-semibold text-[18.66px] leading-[35.59px] tracking-[-0.02em] " >
                        <img className="w-8" src="images/dashBoard/askAi.svg" alt="" />
                         Ask Ai
                    </button>
                </div>
                ...
                <div className="pt-3 pb-5 flex items-center justify-between pr-5">
                    ...
                    <button className="text-[#FF3400] font-pp-mori font-semibold text-[21.33px] leading-[31.99px] tracking-[0%]">view all</button>
                </div>
